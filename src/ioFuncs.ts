...
const ios: Record<string, Record<string, IoProperty>> = {
  ...
  bus: {
    ...
    'EQchannel[0]cell[0]gain': { out: 'EQ.channel[0].cell[0].gain', val: 'EQ.channel[0].cell[0].gain', type: 'float' },
    'EQchannel[0]cell[1]gain': { out: 'EQ.channel[0].cell[1].gain', val: 'EQ.channel[0].cell[1].gain', type: 'float' },
    'EQchannel[0]cell[2]gain': { out: 'EQ.channel[0].cell[2].gain', val: 'EQ.channel[0].cell[2].gain', type: 'float' },
    'EQchannel[0]cell[3]gain': { out: 'EQ.channel[0].cell[3].gain', val: 'EQ.channel[0].cell[3].gain', type: 'float' },
    'EQchannel[0]cell[4]gain': { out: 'EQ.channel[0].cell[4].gain', val: 'EQ.channel[0].cell[4].gain', type: 'float' },
    'EQchannel[1]cell[0]gain': { out: 'EQ.channel[1].cell[0].gain', val: 'EQ.channel[1].cell[0].gain', type: 'float' },
    'EQchannel[1]cell[1]gain': { out: 'EQ.channel[1].cell[1].gain', val: 'EQ.channel[1].cell[1].gain', type: 'float' },
    'EQchannel[1]cell[2]gain': { out: 'EQ.channel[1].cell[2].gain', val: 'EQ.channel[1].cell[2].gain', type: 'float' },
    'EQchannel[1]cell[3]gain': { out: 'EQ.channel[1].cell[3].gain', val: 'EQ.channel[1].cell[3].gain', type: 'float' },
    'EQchannel[1]cell[4]gain': { out: 'EQ.channel[1].cell[4].gain', val: 'EQ.channel[1].cell[4].gain', type: 'float' },
    gain: { out: 'gain', val: 'gain', type: 'float' },
